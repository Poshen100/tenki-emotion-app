...
### ⑦ 🔴 Today 英雄區也在穿模板色 —— 而且是 founder 的實機截圖抓到的
...
| 4.5 | 🔴 Today 英雄區的 `.tl-edge-zone` / `.tl-edge-cta` 不再吃 `--primary`（見 ⑦）；信心膠囊改掉那個 gold（見 ⑧）| 低，而且是**現在就在漏的 2.34:1**，founder 實機看得到 |
