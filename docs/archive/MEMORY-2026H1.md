# MEMORY 歸檔 — 2026 上半年（2026-04-07 ~ 2026-06-22 條目原文照搬）

> 依 `.cursor/harness/05_maintenance.md` §4 精簡協議於 2026-07-04 歸檔（當時 MEMORY.md 1206 行 > 1200 觸發線）。
> 原文未改寫；現行日誌見根目錄 `MEMORY.md`。
