...
/**
 * 星塵之魂 — 抽象生理訊號渦・無五官（取代 🙂 ・ Face Method · Beta）
 * 造型：ECG 橫波橫貫 + 外環 + 核心光點，帶醫療生物檢測感。漸層描邊。
 */
export function SoulFace({ size = 24, ...props }: TenkiIconProps) {
  ...
  return (
    ...
    >
      ...
      <g stroke={`url(#${id})`} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" fill="none">
        <path d="M4 12 h3 l1.2 -4 l1.6 8 l1.3 -5 l1.1 3 h1.5 l1.2 -2.4 l1.4 4 l1 -3.6 h2.2" />
        <circle cx="12" cy="12" r="9" strokeWidth={1} opacity={0.22} />
      </g>
