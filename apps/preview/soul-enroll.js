...
(function () {
  ...
  function drawProcessingOrb(c, cx, cy, t, opts = {}) {
    ...
    const ORBITS = [
      { rr: R * 0.96, tilt: 1.18, roll: 0.00, prec: 0.00065, spin: 0.00145, head: 0.00400, grit: 420 },
      { rr: R * 0.86, tilt: -0.82, roll: 1.15, prec: 0.00088, spin: -0.00120, head: 0.00560, grit: 390 },
      { rr: R * 0.74, tilt: 0.50, roll: -1.05, prec: 0.00119, spin: 0.00187, head: -0.00700, grit: 340 },
      { rr: R * 0.60, tilt: -1.30, roll: 0.55, prec: 0.00104, spin: 0.00255, head: 0.00900, grit: 280 },
    ];
