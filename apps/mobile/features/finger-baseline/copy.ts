 ...
 *      dramatised.
 *   4. 🔴 Nothing here says HRV, and nothing calls one capture a baseline.
 *      Camera HRV is withheld (`camera_hrv_estimates`, default off — see
 *      docs/PHONE-PPG.md §10), and a baseline is a distribution across days
...
export const FINGER_BASELINE_COPY = {
  ...
  /** What the camera cannot do. Said here rather than left to be assumed. */
  limits: '相機讀不到逐拍之間的間隔，所以不報心律變異，也不報呼吸率 —— 那兩項需要胸帶或手錶。',
